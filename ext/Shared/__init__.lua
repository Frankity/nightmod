class "NightModShared"

g_Logger = require '__shared/Logger'


function NightModShared:__init()
	g_Logger:Write("NightModShared: Shared Init.")
...
function NightModShared:OnReadInstance(p_Instance, p_Guid)
...
g_NightModShared = NightModShared()